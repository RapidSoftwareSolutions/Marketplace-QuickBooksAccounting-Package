...
$app->post('/api/QuickBooksAccounting/updateTransfer', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'transferId', 'companyId', 'syncToken', 'amount']);
    ...
    $body['sparse'] = true;
    $body['Id'] = $post_data['args']['transferId'];
