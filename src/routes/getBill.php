...
$app->post('/api/QuickBooksAccounting/getBill', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'billId', 'companyId']);
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/bill/' . $post_data['args']['billId'], ['auth' => 'oauth']);
