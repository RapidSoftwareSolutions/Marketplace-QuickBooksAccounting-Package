...
$app->post('/api/QuickBooksAccounting/getInvoiceAsPDF', function ($request, $response, $args) {
    ...
    $client->getAsync('company/' . $post_data['args']['companyId'] . '/invoice/' . $post_data['args']['invoiceId'] . '/pdf',
        [
