...
$app->post('/api/QuickBooksAccounting/getEmployee', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'employeeId', 'companyId']);
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/employee/' . $post_data['args']['employeeId'], ['auth' => 'oauth']);
