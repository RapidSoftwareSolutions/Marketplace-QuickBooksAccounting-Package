...
$app->post('/api/QuickBooksAccounting/createTerm', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'name', 'companyId', 'dueDays']);
