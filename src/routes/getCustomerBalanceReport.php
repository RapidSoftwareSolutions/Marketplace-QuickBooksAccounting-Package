...
$app->post('/api/QuickBooksAccounting/getCustomerBalanceReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/CustomerBalance', ['auth' => 'oauth', 'query' => $body]);
