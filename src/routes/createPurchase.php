...
$app->post('/api/QuickBooksAccounting/createPurchase', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'purchaseLines', 'companyId', 'accountRefId', 'paymentType']);
