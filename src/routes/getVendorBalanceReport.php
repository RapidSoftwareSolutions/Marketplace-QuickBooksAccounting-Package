...
$app->post('/api/QuickBooksAccounting/getVendorBalanceReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/VendorBalance', ['auth' => 'oauth', 'query' => $body]);
