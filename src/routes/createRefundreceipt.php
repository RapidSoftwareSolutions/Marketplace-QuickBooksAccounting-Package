...
$app->post('/api/QuickBooksAccounting/createRefundreceipt', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'refundLines', 'companyId', 'depositToAccountId']);
