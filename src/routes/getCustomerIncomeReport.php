...
$app->post('/api/QuickBooksAccounting/getCustomerIncomeReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/CustomerIncome', ['auth' => 'oauth', 'query' => $body]);
