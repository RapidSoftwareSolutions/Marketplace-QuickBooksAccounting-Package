...
$app->post('/api/QuickBooksAccounting/getEstimate', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/estimate/' . $post_data['args']['estimateId'], ['auth' => 'oauth']);
