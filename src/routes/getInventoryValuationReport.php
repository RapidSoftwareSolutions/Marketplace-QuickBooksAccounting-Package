...
$app->post('/api/QuickBooksAccounting/getInventoryValuationReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/InventoryValuationSummary', ['auth' => 'oauth', 'query' => $body]);
