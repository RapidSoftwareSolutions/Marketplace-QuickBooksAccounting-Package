...
$app->post('/api/QuickBooksAccounting/createTaxAgency', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('POST', 'company/' . $post_data['args']['companyId'] . '/taxagency', ['auth' => 'oauth', 'json' => $body]);
