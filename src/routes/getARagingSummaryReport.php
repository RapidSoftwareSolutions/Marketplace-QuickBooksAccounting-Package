...
$app->post('/api/QuickBooksAccounting/getARagingSummaryReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/AgedReceivables', ['auth' => 'oauth', 'query' => $body]);
