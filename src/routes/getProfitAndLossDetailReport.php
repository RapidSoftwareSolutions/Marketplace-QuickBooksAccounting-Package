...
$app->post('/api/QuickBooksAccounting/getProfitAndLossDetailReport', function ($request, $response, $args) {
    ...
    if (isset($post_data['args']['employee']) && strlen($post_data['args']['employee']) > 0) {
        $body['employee'] = $post_data['args']['employee'];
    }
