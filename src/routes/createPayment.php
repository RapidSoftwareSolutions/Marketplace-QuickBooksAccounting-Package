...
$app->post('/api/QuickBooksAccounting/createPayment', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'companyId', 'customerRefId', 'totalAmt']);
