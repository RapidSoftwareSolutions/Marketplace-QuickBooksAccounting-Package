...
$app->post('/api/QuickBooksAccounting/getInvoice', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'invoiceId', 'companyId']);
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/invoice/' . $post_data['args']['invoiceId'], ['auth' => 'oauth']);
