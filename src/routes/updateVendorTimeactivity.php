...
$app->post('/api/QuickBooksAccounting/updateVendorTimeactivity', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'companyId', 'timeactivityId', 'syncToken', 'vendorRefId']);
