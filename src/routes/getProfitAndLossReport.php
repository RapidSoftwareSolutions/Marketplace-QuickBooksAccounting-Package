...
$app->post('/api/QuickBooksAccounting/getProfitAndLossReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/ProfitAndLoss', ['auth' => 'oauth', 'query' => $body]);
