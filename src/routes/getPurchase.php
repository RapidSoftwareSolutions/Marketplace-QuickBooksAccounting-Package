...
$app->post('/api/QuickBooksAccounting/getPurchase', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'purchaseId', 'companyId']);
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/purchase/' . $post_data['args']['purchaseId'], ['auth' => 'oauth']);
