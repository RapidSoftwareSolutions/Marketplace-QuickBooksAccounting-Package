...
$app->post('/api/QuickBooksAccounting/getCustomer', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'customerId', 'companyId']);
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/customer/' . $post_data['args']['customerId'], ['auth' => 'oauth']);
