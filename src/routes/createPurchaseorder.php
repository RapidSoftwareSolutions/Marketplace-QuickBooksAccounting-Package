...
$app->post('/api/QuickBooksAccounting/createPurchaseorder', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'purchaseorderLines', 'companyId', 'vendorRefId', 'aPAccountRefID']);
