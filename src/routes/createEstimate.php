...
$app->post('/api/QuickBooksAccounting/createEstimate', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'estimateLines', 'companyId', 'customerRefId']);
