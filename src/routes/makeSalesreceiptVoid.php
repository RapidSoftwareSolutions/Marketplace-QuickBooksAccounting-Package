...
$app->post('/api/QuickBooksAccounting/makeSalesreceiptVoid', function ($request, $response, $args) {
...
//
    try {
        $resp = $client->request('POST', 'company/' . $post_data['args']['companyId'] . '/salesreceipt?include=void', ['auth' => 'oauth', 'json' => $body]);
