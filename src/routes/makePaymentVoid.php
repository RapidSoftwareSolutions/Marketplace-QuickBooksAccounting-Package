...
$app->post('/api/QuickBooksAccounting/makePaymentVoid', function ($request, $response, $args) {
...
//
    try {
        $resp = $client->request('POST', 'company/' . $post_data['args']['companyId'] . '/payment?include=void', ['auth' => 'oauth', 'json' => $body]);
