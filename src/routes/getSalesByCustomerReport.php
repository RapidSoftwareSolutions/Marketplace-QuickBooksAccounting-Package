...
$app->post('/api/QuickBooksAccounting/getSalesByCustomerReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/ClassSales', ['auth' => 'oauth', 'query' => $body]);
