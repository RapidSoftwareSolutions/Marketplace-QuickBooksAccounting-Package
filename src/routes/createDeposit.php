...
$app->post('/api/QuickBooksAccounting/createDeposit', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'depositLines', 'companyId', 'depositToAccountRefId']);
