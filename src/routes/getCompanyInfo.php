...
$app->post('/api/QuickBooksAccounting/getCompanyInfo', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/companyinfo/'.$post_data['args']['companyId'], ['auth' => 'oauth', 'query'=> $body]);
