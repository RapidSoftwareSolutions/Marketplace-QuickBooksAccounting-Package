...
$app->post('/api/QuickBooksAccounting/getBalanceSheetReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/BalanceSheet', ['auth' => 'oauth', 'query' => $body]);
