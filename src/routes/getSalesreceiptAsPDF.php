...
$app->post('/api/QuickBooksAccounting/getSalesreceiptAsPDF', function ($request, $response, $args) {
    ...
    $client->getAsync('company/' . $post_data['args']['companyId'] . '/salesreceipt/' . $post_data['args']['salesreceiptId'] . '/pdf',
        [
