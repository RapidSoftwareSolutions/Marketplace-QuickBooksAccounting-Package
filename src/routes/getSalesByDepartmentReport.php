...
$app->post('/api/QuickBooksAccounting/getSalesByDepartmentReport', function ($request, $response, $args) {
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/reports/DepartmentSales', ['auth' => 'oauth', 'query' => $body]);
