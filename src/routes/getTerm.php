...
$app->post('/api/QuickBooksAccounting/getTerm', function ($request, $response, $args) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiKey', 'apiSecret', 'accessToken', 'tokenSecret', 'termId', 'companyId']);
    ...
    try {
        $resp = $client->request('GET', 'company/' . $post_data['args']['companyId'] . '/term/' . $post_data['args']['termId'], ['auth' => 'oauth']);
